...
### [pexels-media](./pexels-media/)

**Pexels 免費圖庫素材搜尋下載器** — 透過 Pexels API 搜尋、下載高品質免費圖片與影片，自動建立中繼資料檔（含攝影師、授權、解析度等資訊），方便追溯來源。

- 支援圖片與影片搜尋（關鍵字、色調、方向、尺寸篩選）
- 精選照片、熱門影片、收藏集等多種探索方式
- 每個下載自動附帶 `.meta.json` 中繼資料
- 所有素材均為 Pexels 授權，可用於個人與商業專案
